...
export class MovementBalanceTool extends Tool {
	name = "movement_balance"
	description = `Get the balance of a Movement account.

  If you want to get the balance of your wallet, you don't need to provide the mint.
  If no mint is provided, the balance will be in MOVE.
